<p align="center">
  <img src="https://i.ibb.co/dJ0gpJf1/photo-2025-06-16-12-07-05-7516517596376596504.jpg" alt=" botroomz  Logo">
</p>
<h1 align="center">
  VJ FILTER BOT
</h1>

![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=Welcome+To+deg+Filter+Bot!)
</p>
...
[![Contact Developer](https://img.shields.io/static/v1?label=Contact+Developer&message=On+Telegram&color=critical)](https://t.me/Dmconnectorbot)

<b>Fork The Repo And Edit As Per Your Needs.</b>

## Disclaimer

<b>This is just a Telegram bot for learning purposes about the Pyrogram Library and Python programming language. This project doesn't hold any files. All content shared through the bot is fetched from publicly available sources, and this project has no control over the content's legality, quality, or accuracy. It's the end users' responsibility to make sure the media they access complies with local laws before downloading.</b>
